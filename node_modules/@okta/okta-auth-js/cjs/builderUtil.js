...
function assertValidConfig(args) {
  ...
  if (userAgentTemplateWithNoPlaceholder) {
    throw new _AuthSdkError.default('UserAgentTemplate must include "$OKTA_AUTH_JS" placeholder. ' + 'Required usage: new OktaAuth({userAgentTemplate: "xxx $OKTA_AUTH_JS xxx"})');
  }
}
