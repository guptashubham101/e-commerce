...
function getSession(sdk) {
  return _http.default.get(sdk, '/api/v1/sessions/me', {
    withCredentials: true
  }).then(function (session) {
    var res = (0, _util.omit)(session, '_links');

    res.refresh = function () {
      return _http.default.post(sdk, (0, _util.getLink)(session, 'refresh').href, {}, {
        withCredentials: true
      });
    };

    res.user = function () {
      return _http.default.get(sdk, (0, _util.getLink)(session, 'user').href, {
        withCredentials: true
      });
    };
...
function refreshSession(sdk) {
  return _http.default.post(sdk, '/api/v1/sessions/me/lifecycle/refresh', {}, {
    withCredentials: true
  });
}
