...
function transactionStatus(sdk, args) {
  ...
  return _http.default.post(sdk, sdk.getIssuerOrigin() + '/api/v1/authn', args, {
...
function transactionStep(sdk, args) {
  ...
  return _http.default.post(sdk, sdk.getIssuerOrigin() + '/api/v1/authn/introspect', args, {
    withCredentials: true
  });
}
...
function postToTransaction(sdk, url, args, options) {
  return _http.default.post(sdk, url, args, options).then(function (res) {
    return new _AuthTransaction.AuthTransaction(sdk, res);
  });
}
