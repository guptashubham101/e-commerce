...
import { authenticate, cancel, register, recoverPassword, startTransaction, handleInteractionCodeRedirect } from './idx';
...
class OktaAuth {
  constructor(args) {
    ...
    if (isBrowser()) {
      ...
      this.userAgent = getUserAgent(args, "okta-auth-js/".concat("5.2.3"));
    } else {
      this.userAgent = getUserAgent(args, "okta-auth-js-server/".concat("5.2.3"));
